...
def parse_args():
        AP =  argparse.ArgumentParser("Detect snv and indel")
        ...
        AP.add_argument('-fa',help="fasta file",dest="fasta",default="/home/ruiyang.gao/Database/hsa_Ref/hg38/hg38.fasta")
